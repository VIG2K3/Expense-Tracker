...
# New Expense heading
heading = CTkLabel(master=frame_1, text='New Expenses', fg_color="#FFFFFF", font=('Arial', 23), corner_radius=30)
...
addexp_entry = CTkEntry(master=frame_1, fg_color="#FFFFFF", width=400, height=50,
...
catbills_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='BILLS', text_color='#000000',
                            fg_color="#FFFFFF", border_width=0)
catbills_button.place(relx=0.29, rely=0.05)

# Category button (Shopping)
catshop_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='SHOPPING', text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
catshop_button.place(relx=0.54, rely=0.05)

# Category button (House)
cathouse_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='HOUSE', text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
cathouse_button.place(relx=0.79, rely=0.05)

# Category button (F&B)
catfnb_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='F&B', text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
catfnb_button.place(relx=0.04, rely=0.35)

# Category button (Entertainment)
catenter_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='ENTERTAINMENT',
                          text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
catenter_button.place(relx=0.29, rely=0.35)

# Category button (Transport)
cattran_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='TRANSPORT', text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
cattran_button.place(relx=0.54, rely=0.35)

# Category button (Pets)
catpets_button = CTkButton(master=frame_2, compound="top", width=150, height=100, text='PETS', text_color='#000000',
                          fg_color="#FFFFFF", border_width=0)
...
homepage_button = CTkButton(master=frame_1, text="Switch to Register Page", command=switch_to_homepage)
homepage_button.place(relx=0.0, rely=0.0)
